...
function displayQuestion() {
    ...
    const themeContainer = document.getElementById('theme-container'); // Elemento para exibir o tema
    const question = questions[currentQuestionIndex];

    // Exibir tema
    themeContainer.innerHTML = `<h3>Tema: ${question.theme}</h3>`;

    // Exibir questão e opções
